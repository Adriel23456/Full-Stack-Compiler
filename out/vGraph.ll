...
then.7:
  ...
  %".311" = fadd double 0x4020000000000000, 0x3fe0000000000000
...
for.incr:
  %".42" = load double, double* @"sparkleT"
  %".43" = fadd double %".42", 0x3ff0000000000000
  store double %".43", double* @"sparkleT"
  br label %"for.cond"
for.end:
  ret void
then:
  ...
  %".38" = fadd double 0x4024000000000000, 0x3fe0000000000000
  %".39" = fptosi double %".38" to i32
  call void @"vg_wait"(i32 %".39")
  br label %"for.incr"
else:
  store i32 16776960, i32* @"col"
  br label %"endif"
