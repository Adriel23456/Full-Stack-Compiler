...
class VGraphListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by VGraphParser#type.
    def enterType(self, ctx:VGraphParser.TypeContext):
        pass

    # Exit a parse tree produced by VGraphParser#type.
    def exitType(self, ctx:VGraphParser.TypeContext):
        pass
